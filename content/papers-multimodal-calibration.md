...
[PDF Download My Conference Paper](https://ieeexplore.ieee.org/document/7360336 )
  ...
  ![My Conference Paper  Camera Calibration for Multi-Modal Robot Vision ](/assets/img/camera-calibration-multi-modal.png)

  <img src="/assets/img/camera-calibration-multi-modal.png" alt="My Conference Paper: Camera Calibration for Multi-Modal Robot Vision "  style="max-width: 100%; height: auto;">
