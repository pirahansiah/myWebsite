  ...
  <div class="reveal">
    <div class="slides">
      ...
      <section>
        ...
        <p style="color:#6b7280; margin-top:1em; font-size: 0.9em">
          <strong>Dr. Farshid Pirahansiah</strong> • <span style="color:#1a56db">AI & Computer Vision Engineer</span><br>
      ...
      <section>
        ...
        <div class="m-2">
          ...
          <div class="c c-left">
            <h3 style="color:#15803d">🧩 Extensibility</h3>
        ...
        <p style="margin-top:0.6em; color:#6b7280; font-size:0.8em">Install: <code>curl -fsSL https://hermes-agent.nousresearch.com/install.sh | bash</code></p>
      </section>
...
<span class="cmt"># In chat: /model cheap   (session) or --global (persist)</span></pre>
      ...
      <section>
        ...
        <div class="m-2">
          <div class="c c-left">
            <h3 style="color:#1a56db">📚 Catalog</h3>
          ...
          <div class="c c-left">
            <h3 style="color:#92400e">⚡ Create Your Own</h3>
...
<span class="cmt"># writes SKILL.md → loads on match</span></pre>
      ...
      <section>
        ...
        <p style="font-size:0.62em; color:#6b7280">Installed via <code>hermes skills install</code> / URL, scanned, and verified (valid SKILL.md frontmatter, enabled).</p>
        <div class="m-3">
          <div class="c"><h3 style="color:#1a56db">Web &amp; Research</h3>
          ...
          <div class="c"><h3 style="color:#6d28d9">Build &amp; Engineering</h3>
          ...
          <div class="c"><h3 style="color:#1a56db">Agents &amp; Ops</h3>
...
<span class="cmt"># 14 skills installed & validated · 15 community/url total now active</span>
        ...
        <p style="font-size:0.5em; color:#92400e">Blocked by security scan (dangerous verdict, --force cannot override): codebase-memory-mcp, openmontage, composio, claude-mem, rlaope/oh-my-hermes. Plugin-only (not flat SKILL.md): witt3rd/oh-my-hermes, agent37/minions. Use curated repo paths or audit before install.</p>
      </section>
      ...
      <section>
        ...
        <div class="m-2">
          <div class="c c-left">
            <h3 style="color:#1a56db">🧠 What It Remembers</h3>
          ...
          <div class="c c-left">
            <h3 style="color:#15803d">🔁 Across Sessions</h3>
...
<span class="cmt"># Coordinator merges verified summaries — no manual glue.</span></pre>
        ...
        <p style="margin-top:0.5em; font-size:0.78em; color:#6b7280">Also: <code>hermes moa</code> (Mixture-of-Agents), <code>hermes kanban</code> (work-queue), <code>--worktree</code> (isolated checkouts).</p>
      </section>
...
<span class="cmd">hermes cron list</span> | <span class="cmd">pause</span> | <span class="cmd">resume</span> | <span class="cmd">run ID</span></pre>
        ...
        <p style="font-size:0.78em; color:#6b7280; margin-top:0.5em">Survives reboots; runs headless; notifies on completion or failure.</p>
      </section>
      ...
      <section>
        ...
        <p style="margin-top:0.5em; font-size:0.78em; color:#6b7280">Lit sweep → code reproduce → experiment → draft, all agent-driven.</p>
      </section>
      ...
      <section>
        ...
        <div class="m-2">
          <div class="c c-left">
            <h3 style="color:#1a56db">⚡ Performance</h3>
          ...
          <div class="c c-left">
            <h3 style="color:#15803d">🐛 Systematic Debug</h3>
      ...
      <section>
        ...
        <p style="font-size:0.76em; color:#6b7280; margin-top:0.4em"><span class="feat">Webhooks</span><span class="feat">ACP / IDE</span><span class="feat">Pets</span><span class="feat">Skins</span><span class="feat">TTS/STT</span><span class="feat">Computer Use</span><span class="feat">Import Claude/Codex</span></p>
      </section>
      ...
      <section>
        ...
        <p style="margin-top:0.5em; color:#1a56db; font-size:0.85em">→ Every feature shown above has a working example in this deck.</p>
      </section>
      ...
      <section>
        ...
        <p style="margin-top:0.8em; color:#1a56db; font-size:1.0em; font-weight:bold">pirahansiah.com/notes/slides/</p>
      </section>
...
<span class="cmt"># type / + letters for autocomplete; /help for full list</span>
      ...
      <section>
        ...
        <p style="margin-top:1.2em">
          <a href="https://www.pirahansiah.com/notes/docs/" style="color:#1a56db; text-decoration:underline">Documentation</a> •
