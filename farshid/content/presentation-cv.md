...
<span class="cmd">hermes bot create cv-alerts --platform telegram --group "CV War Room"</span></pre>
      ...
      <section>
        ...
        <p style="margin-top:1em; color:#1a56db; font-size:1.05em; font-weight:bold">pirahansiah.com/notes/docs/cv/</p>
      </section>
...
<span class="cmt"># type / + letters for autocomplete; /help for full list</span>
      ...
      <section>
        ...
        <p style="margin-top:1.5em">
          <a href="https://www.pirahansiah.com/notes/docs/cv/" style="color:#1a56db; text-decoration:underline">CV Documentation</a> •
