  ...
  <div class="reveal">
    <div class="slides">
      ...
      <section>
        ...
        <div class="era">
          <div class="c">
            <h3 style="color:#b42318">📚 The Old Way</h3>
          ...
          <div class="arrow">➜</div>
          <div class="c cyan">
            <h3 style="color:#15803d">🤖 The New Era</h3>
        ...
        <p style="margin-top:0.8em; color:#2b3038">Tools now <em>act</em>, not just answer. The researcher directs; the stack executes.</p>
      </section>
      ...
      <section>
        ...
        <div class="m-3">
          <div class="c cyan c-left">
            <h3 style="color:#1a56db">🛠️ Orchestration</h3>
          ...
          <div class="c c-left">
            <h3 style="color:#15803d">🖼️ Insight & Illustration</h3>
          ...
          <div class="c glow c-left">
            <h3 style="color:#6d28d9">📑 Citations & KB</h3>
        ...
        <p style="margin-top:0.7em; font-size:0.76em; color:#6b7280">Hermes ties them together: <code>deepdive</code> ≈ Deep Research · <code>factcheck</code> ≈ Trust Cards · <code>cite</code> ≈ citation finders · <code>obsidian</code> ≈ second brain.</p>
      </section>

      
      <section>
        <h2>Hermes Research Skills Catalog</h2>
        <p style="font-size:0.7em; color:#6b7280; text-align:center">8 new research skills + 8 existing — literature sweeps, critique, synthesis & citation.</p>
          ...
          <table style="width:100%; border-collapse:collapse; color:#2b3038">
            <thead>
              <tr style="color:#1a56db; text-align:left">
                <th style="padding:3px 8px; border-bottom:1px solid rgba(26,86,219,.35)">Skill</th>
                <th style="padding:3px 8px; border-bottom:1px solid rgba(26,86,219,.35)">Trigger / what it does</th>
                <th style="padding:3px 8px; border-bottom:1px solid rgba(26,86,219,.35)">Status</th>
              </tr>
            </thead>
            <tbody>
      ...
      <section>
        ...
        <p style="margin-top:0.5em; font-size:0.72em; color:#6b7280">Hermes mapping: <code>deepdive</code>/<code>literature-review</code> ≈ Deep Research · <code>grounded-citations</code>/<code>factcheck</code> ≈ Trust Cards/Claim Radar · <code>cite</code> ≈ Author Search.</p>
      </section>
      ...
      <section>
        ...
        <ol style="text-align:left; max-width:860px; margin:0.5em auto; font-size:0.82em; line-height:1.6; color:#2b3038">
      ...
      <section>
        ...
        <p style="margin-top:1.1em; color:#1a56db; font-size:1.05em; font-weight:bold">Explore the tooling &amp; code: pirahansiah.com</p>
      </section>
...
<span class="cmt"># type / + letters for autocomplete; /help for full list</span>
      ...
      <section>
        ...
        <h2 style="color:#2b3038">The New Era of Research Tools</h2>
        <p style="margin-top:1.5em">
          <a href="https://www.pirahansiah.com/notes/slides/" style="color:#1a56db; text-decoration:underline">All Presentations</a> •
