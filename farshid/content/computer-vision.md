...
- [Dr. Farshid Pirahansiah CV](/farshid/content/computer-vision.md)
...
### My Patents (3)   
  - [My Patents: A METHOD FOR AUGMENTING A PLURALITY OF FACE IMAGES WO2021060971A1](/farshid/content/patents-face-augmentation.md)
  - [My Patents: SYSTEM AND METHOD FOR PROVIDING ADVERTISEMENT CONTENTS BASED ON FACIAL ANALYSIS WO2020141969A2](/farshid/content/patents-facial-analysis.md)
  - [My Patents: A METHOD FOR DETECTING A MOVING VEHICLE WO2021107761A1](/farshid/content/patents-vehicle-detection.md)    
### My Books (2)
  - [My Book: My_Book_chapter_Camera_Calibration_and_Video_Stabilization_Framework_for_Robot_Localization  in the Book entitled “Control Engineering in Robotics and Industrial Automation" published in Springer](/farshid/content/books-camera-calibration.md)
  - [My Book: Computational Intelligence: From Theory to Application explores augmented optical flow methods for video stabilization](/farshid/content/books-computational-intelligence.md)     
### My Journals (6)    
  - [My Journal Publications: Adaptive Image Thresholding Based on the Peak Signal-to-noise Ratio (PSNR) ](/farshid/content/journals-adaptive-thresholding.md)
  - [My Journal Publications: CHARACTER AND OBJECT RECOGNITION BASED ON GLOBAL FEATURE EXTRACTION](/farshid/content/journals-character-recognition.md)
  - [My Journal Publications: GSFT-PSNR Global Single Fuzzy Threshold](/farshid/content/journals-fuzzy-thresholding.md)
  - [My Journal Publications: PEAK SIGNAL-TO-NOISE RATIO BASED ON THRESHOLD METHOD FOR IMAGE SEGMENTATION](/farshid/content/journals-psnr-segmentation.md)
  - [My Journal Publications: 3D SLAM Simultaneous Localization And Mapping Trends And Humanoid Robot Linkages](/farshid/content/journals-3d-slam-humanoid.md)
  - [My Journal Publications: USING AN ANT COLONY OPTIMIZATION ALGORITHM](/farshid/content/journals-ant-colony.md)    
### My Conference Papers (10)    
  - [My Conference Papers: 2D versus 3D Map for Environment Movement Objects  ](/farshid/content/papers-2d-3d-mapping.md)
  - [My Conference Papers: Adaptive Image Segmentation Based on PSNR for License Plate Recognition ](/farshid/content/papers-adaptive-segmentation.md)
  - [My Conference Papers: An evaluation of classification techniques using enhanced Geometrical Topological Feature Analysis ](/farshid/content/papers-geometrical-topological.md)
  - [My Conference Papers: Camera Calibration for Multi-Modal Robot Vision ](/farshid/content/papers-multimodal-calibration.md)
  - [My Conference Papers: Character Recognition Based on Global Feature ](/farshid/content/papers-global-feature-recognition.md)
  - [My Conference Papers: Comparison single thresholding method for handwritten images segmentation ](/farshid/content/papers-handwritten-thresholding.md)
  - [My Conference Papers: License Plate Recognition with Multi-Threshold Based on Entropy ](/farshid/content/papers-license-plate-recognition.md)
  - [My Conference Papers: Multi-threshold Approach for License Plate Recognition System ](/farshid/content/papers-multi-threshold-plate.md)
  - [My Conference Papers: Pattern Image Significance for Camera Calibration](/farshid/content/papers-pattern-calibration.md)
  - [My Conference Papers: TafreshGrid Grid computing in Tafresh university ](/farshid/content/papers-grid-computing.md)
